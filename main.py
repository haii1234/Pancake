...
def send_email(message: dict, test: bool = False) -> None:
    ...
    if not test:
        msg["Cc"] = "biancazhg9@gmail.com, huan2137@purdue.edu, 27d.gao@gmail.com, bgl2126@columbia.edu, jl7026@columbia.edu, doraliao502@gmail.com, acb2319@columbia.edu, dea2142@columbia.edu"
